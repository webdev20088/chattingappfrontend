...
export default function Sorry() {
 ...
 const questionImages = [
  ...
  const gifsRound2 = [
    ...
    "https://media.giphy.com/media/xT8qBepJQzUjN1TtO4/giphy.gif",
    "https://media.giphy.com/media/3o7aTskHEUdgCQAXde/giphy.gif",
    "https://media.giphy.com/media/l4FGuhL4U2WyjdkaY/giphy.gif",
    "https://media.giphy.com/media/3oz8xIsloV7zOmt81G/giphy.gif",
  ];

  // Track current GIF index for both rounds
  const [currentGifIndex, setCurrentGifIndex] = useState(0);
  const [currentGifIndex2, setCurrentGifIndex2] = useState(0);

  // Enable question Next after countdown
  useEffect(() => {
    if (stage === 2) {
  ...
  // Enable video Next after countdown
  useEffect(() => {
    if (stage === 3) {
  ...
  // GIF stage 1 controls
  const handleNextGif = () => {
    if (currentGifIndex < gifsRound1.length - 1) {
  ...
  // GIF stage 4 controls
  const handleNextGif2 = () => {
    if (currentGifIndex2 < gifsRound2.length - 1) {
      setCurrentGifIndex2(currentGifIndex2 + 1);
    } else {
      setCurrentGifIndex2(0);
      setStage(5);
    }
  };
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Stage 1: GIFs (Round 1, one per tile) */}
      {stage === 1 && (
        <div className={styles.tile}>
          <h2 className={styles.tileTitle}>Enjoy these GIFs</h2>
          <div className={styles.gifTile}>
            <p className={styles.counterText}>{gifsRound1.length - currentGifIndex - 1} more</p>
            <Image
              src={gifsRound1[currentGifIndex]}
              alt={`gif-${currentGifIndex}`}
              width={300}
              height={300}
              unoptimized
            />
          ...
          <div className={styles.buttonGroup}>
            <button className={styles.button} onClick={handleNextGif}>
              {currentGifIndex === gifsRound1.length - 1 ? "Next Section" : "Next"}
            </button>
          </div>
        </div>
      )}
      ...
      {/* Stage 4: GIFs (Round 2, one per tile) */}
      {stage === 4 && (
        <div className={styles.tile}>
          <h2 className={styles.tileTitle}>Enjoy More GIFs</h2>
          <div className={styles.gifTile}>
            <p className={styles.counterText}>{gifsRound2.length - currentGifIndex2 - 1} more</p>
            <Image
              src={gifsRound2[currentGifIndex2]}
              alt={`gif2-${currentGifIndex2}`}
              width={300}
              height={300}
              unoptimized
            />
          ...
          <div className={styles.buttonGroup}>
            <button className={styles.button} onClick={handleNextGif2}>
              {currentGifIndex2 === gifsRound2.length - 1 ? "Next Section" : "Next"}
            </button>
          </div>
        </div>
      )}
      ...
      {stage === 5 && (
        <div className={styles.tile}>
          ...
          <p className={styles.tileText}>
            ye admi kuch nhi deta srif kaam krwata h ek number ka gadha h samosa ? kuch nhi khilaya marta h aur kaam krwata h .
          </p>
          <div className={styles.buttonGroup}>
